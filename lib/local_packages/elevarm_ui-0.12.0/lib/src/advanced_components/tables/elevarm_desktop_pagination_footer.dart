...
class ElevarmDesktopPaginationFooter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    int startData = ((perPage ?? 0) * (currentPage - 1)) + 1;
    int endData = (perPage ?? 0) * currentPage;
    if (totalData != null) {
      if (startData > totalData!) {
        startData = totalData!;
      }
              ...
              children: [
                ...
                ConstrainedBox(
                  ...
                  child: ElevarmDropdownInputField(
                    textInputSize: ElevarmTextInputFieldSize.sm,
                    ...
                    popUpMenuConstrains: const BoxConstraints(
                      maxWidth: 80.0,
                    ),
                    enabled: onChangedLimit != null,
                    onChanged:
                        onChangedLimit != null ? onChangedLimit! : (_) {},
                  ),
                ),
                Text(
