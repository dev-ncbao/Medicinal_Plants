...
import '../../common/user_interaction/selection_behavior.dart' as sf_chart;
...
class SfCartesianChartState extends State<SfCartesianChart>
  ...
  void didChangeDependencies() {
    _stateProperties.renderingDetails.chartTheme = _updateThemeData(
      context,
      Theme.of(context),
      SfChartTheme.of(context),
    );
  ...
  SfChartThemeData _updateThemeData(
    ...
    chartThemeData = chartThemeData.copyWith(
      ...
      plotBandLabelTextStyle: themeData.textTheme.bodySmall!.merge(
        chartThemeData.plotBandLabelTextStyle,
      ),
  ...
  void didUpdateWidget(SfCartesianChart oldWidget) {
    ...
    if (seriesRendererDetails?.selectionBehaviorRenderer != null) {
      final sf_chart.SelectionDetails? selectionDetails =
          sf_chart.SelectionHelper.getRenderingDetails(
  ...
  Widget build(BuildContext context) {
    ...
    _stateProperties.renderingDetails.deviceOrientation = MediaQuery.of(
      context,
    ).orientation;
...
class _ContainerAreaState extends State<ContainerArea> {
                ...
                onTap: () {
                  if (widget._stateProperties.chartState.mounted &&
                    ...
                    if (selectionSeriesDetails.visible ?? false) {
                      final sf_chart.SelectionBehaviorRenderer?
      ...
      StatefulBuilder(
        builder: (BuildContext context, StateSetter stateSetter) {
          ...
          renderWidget = widget._stateProperties.isLoadMoreIndicator
              ? Center(
                  child:
                      widget._stateProperties.chart.loadMoreIndicatorBuilder!(
                        context,
        ...
        for (
          ...
          if (trendline.animationDuration > 0 &&
            ...
            minSeriesInterval =
                ...
                minSeriesInterval;
            trendlineAnimations['$i-$j'] = Tween<double>(begin: 0.0, end: 1.0)
                .animate(
                  CurvedAnimation(
            ...
            if (labelWidget != null) {
              ...
              for (int k = 0; k < dataLabelTemplateYValues.length; k++) {
                ...
                final ChartTemplateInfo templateInfo = ChartTemplateInfo(
                  ...
                  animationDuration: (series.animationDuration + 1000.0)
                      .floor(),
                  widget: labelWidget,
  ...
  void _bindSeriesWidgets() {
    ...
    for (
      ...
      if (_seriesRenderer != null && seriesRendererDetails.visible! == true) {
        ...
        seriesRendererDetails.selectionBehaviorRenderer =
            sf_chart.SelectionBehaviorRenderer(
              selectionBehavior,
              chart,
              widget._stateProperties,
            );
        final sf_chart.SelectionBehaviorRenderer? selectionBehaviorRenderer =
            seriesRendererDetails.selectionBehaviorRenderer;
        sf_chart.SelectionHelper.setSelectionBehaviorRenderer(
          _series.selectionBehavior,
          selectionBehaviorRenderer!,
        );
        // ignore: unnecessary_null_comparison
        if (selectionBehaviorRenderer != null) {
          final sf_chart.SelectionDetails selectionDetails = sf_chart
        ...
        if (seriesRendererDetails.animationController != null &&
          ...
          seriesRendererDetails.seriesAnimation =
              Tween<double>(begin: 1, end: 1.0).animate(
                CurvedAnimation(
  ...
  CartesianSeriesRenderer? _findSeries(Offset position) {
    CartesianSeriesRenderer? seriesRenderer;
    sf_chart.SelectionBehaviorRenderer? selectionBehaviorRenderer;
    outerLoop:
    for (
      int i =
  ...
  void _calculatePinchZoomingArgs() {
    ...
    for (
      ...
      final ChartAxisRendererDetails
      axisDetails = AxisHelper.getAxisRendererDetails(
        widget._stateProperties.chartAxis.axisRenderersCollection[axisIndex],
      );
  ...
  void _performLongPress() {
    ...
    if (widget._stateProperties.chartSeries.visibleSeriesRenderers != null &&
      ...
      final CartesianSeriesRenderer selectionSeriesRenderer = _findSeries(
        position,
      )!;
      final SeriesRendererDetails seriesRendererDetails =
      ...
      sf_chart.SelectionHelper.getRenderingDetails(
        selectionBehaviorRenderer,
      ).selectionRenderer!.seriesRendererDetails = seriesRendererDetails;
