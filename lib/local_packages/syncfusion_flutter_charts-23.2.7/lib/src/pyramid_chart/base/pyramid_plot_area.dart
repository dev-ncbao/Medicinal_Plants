...
import '../../common/user_interaction/selection_behavior.dart' as fs_charts;
...
class PyramidPlotArea extends StatelessWidget {
  ...
  void _bindSeriesWidgets() {
    ...
    final List<PyramidSeriesRendererExtension> visibleSeriesRenderers =
        stateProperties.chartSeries.visibleSeriesRenderers;
    fs_charts.SelectionBehaviorRenderer selectionBehaviorRenderer;
    ...
    for (int i = 0; i < visibleSeriesRenderers.length; i++) {
      ...
      selectionBehaviorRenderer = seriesRenderer.selectionBehaviorRenderer =
          fs_charts.SelectionBehaviorRenderer(
            selectionBehavior,
            chart,
            stateProperties,
          );
      fs_charts.SelectionHelper.setSelectionBehaviorRenderer(
        series.selectionBehavior,
        selectionBehaviorRenderer,
      );
      selectionBehaviorRenderer = seriesRenderer.selectionBehaviorRenderer;
      final fs_charts.SelectionDetails selectionDetails = fs_charts
